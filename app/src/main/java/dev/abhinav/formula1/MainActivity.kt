...
val drivers = listOf(
    Driver("Alexander Albon", "Williams", "Thailand", 105, 2, 0, R.drawable.albon),
    Driver("Fernando Alonso", "Aston Martin", "Spain", 404, 106, 2, R.drawable.alonso),
    Driver("Valtteri Bottas", "Kick Sauber", "Finland", 246, 67, 0, R.drawable.bottas),
    Driver("Franco Colapinto", "Williams", "Argentina", 9, 0, 0, R.drawable.colapinto),
    Driver("Pierre Gasly", "Alpine", "France", 154, 5, 0, R.drawable.gasly),
    Driver("Lewis Hamilton", "Mercedes", "United Kingdom", 356, 202, 7, R.drawable.hamilton),
    Driver("Nico Hulkenberg", "Haas", "Germany", 230, 0, 0, R.drawable.hulkenberg),
    Driver("Liam Lawson", "RB", "New Zealand", 11, 0, 0, R.drawable.lawson),
    Driver("Charles Leclerc", "Ferrari", "Monaco", 149, 43, 0, R.drawable.leclerc),
    Driver("Kevin Magnussen", "Haas", "Denmark", 186, 1, 0, R.drawable.magnussen),
    Driver("Lando Norris", "McLaren", "United Kingdom", 128, 26, 0, R.drawable.norris),
    Driver("Esteban Ocon", "Alpine", "France", 156, 4, 0, R.drawable.ocon),
    Driver("Sergio Perez", "Red Bull", "Mexico", 282, 39, 0, R.drawable.perez),
    Driver("Oscar Piastri", "McLaren", "Australia", 46, 10, 0, R.drawable.piastri),
    Driver("George Russell", "Mercedes", "United Kingdom", 128, 15, 0, R.drawable.russell),
    Driver("Carlos Sainz", "Ferrari", "Spain", 208, 27, 0, R.drawable.sainz),
    Driver("Lance Stroll", "Aston Martin", "Canada", 167, 3, 0, R.drawable.stroll),
    Driver("Yuki Tsunoda", "RB", "Japan", 90, 0, 0, R.drawable.tsunoda),
    Driver("Max Verstappen", "Red Bull", "Netherlands", 209, 112, 4, R.drawable.verstappen),
